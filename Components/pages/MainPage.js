...
import { View, Text, ImageBackground, StyleSheet, Button, Dimensions } from 'react-native';
...
function MainPage({ navigation }) {
    ...
    return (
        <View style={{ flex: 1 }}>
            <ImageBackground source={image} style={[styles.image, { height: height * 0.7 }]}>
                <View style={styles.overlay}>
                    <View style={styles.bottomLeft}>
                        <Text style={styles.Fashion}>Fashion</Text>
                        <Text style={styles.Sale}>sale</Text>
                        <Button title="Check" onPress={() => console.log('Button Pressed')} color="#FF0000" borderRadius={2} />
                    </View>
                </View>
            </ImageBackground>
